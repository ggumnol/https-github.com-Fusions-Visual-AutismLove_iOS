...
//  AutismLove
//
//  Created by Samuel Krisna on 27/09/21.
//
...
class CustomLayoutSizeCalculator: CellSizeCalculator {
    ...
    func cellTopLabelSize(for message: MessageType,
        ...
        guard let attributedText = self.messagesDataSource.cellTopLabelAttributedText(for: message, at: indexPath) else { return .zero }
